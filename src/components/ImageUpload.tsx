...
export function ImageUpload({
  ...
  return (
    <div className="space-y-4">
      ...
      <div
        className={`
          relative border-2 border-dashed rounded-lg p-6 text-center cursor-pointer transition-colors min-h-[200px] flex flex-col items-center justify-center
          ${
            dragActive
                ...
                className={`
                  ...
                  ${
                    type === "avatar"
                      ...
                      : "w-auto h-32 max-h-32"
                  }
                `}
                onLoad={() => {
                  // 🎨 画像読み込み完了後に削除ボタンを表示するための状態管理
