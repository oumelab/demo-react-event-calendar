    ...
    <div className="max-w-2xl mx-auto py-8">
      ...
      <div className="mb-8">
        ...
        <nav className="text-sm text-gray-500">
          <Link to="/events" className="hover:text-sky-600">
            イベント一覧
          </Link>
          <span className="mx-2">→</span>
          <Link to={`/events/${id}`} className="hover:text-sky-600">
            イベント詳細
          </Link>
          <span className="mx-2">→</span>
      ...
      <div className="bg-white rounded-lg border border-zinc-400 p-6 mt-10">
        <div className="flex space-between items-center">
          <div className="flex-1">
            <h2 className="text-lg font-bold mb-2">イベントを削除する</h2>
          ...
          <div>
            <Button
              ...
              disabled={isDeleting || isUpdating || event.attendees > 0}
              className="ml-4"
            >
              {isDeleting ? (
                <>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <p className="mt-1 text-sm text-yellow-700">
                  現在{event.attendees}
                  人が参加予定です。参加者がいる場合はイベントを削除できません。
      ...
      <div className="my-8 text-center">
        ...
        <Link
          to={`/events/${id}`}
          className="text-sky-600 hover:text-sky-800 text-sm underline underline-offset-2"
        >
          編集をキャンセルして詳細ページに戻る
        </Link>
        </Button>
