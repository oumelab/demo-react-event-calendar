import { onRequest as __api_events__id__delete_ts_onRequest } from "/Users/iwatamini/Desktop/MyPractice/demo-react-event-calendar/functions/api/events/[id]/delete.ts"
...
export const routes = [
    {
      ...
      method: "",
      middlewares: [],
      modules: [__api_events__id__delete_ts_onRequest],
    },
  {
